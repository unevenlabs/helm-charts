...
![Version: 1.0.0](https://img.shields.io/badge/Version-1.0.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 11.3.1](https://img.shields.io/badge/AppVersion-11.3.1-informational?style=flat-square)
...
* <https://helm-charts.unevenlabs.tools>
...
| https://charts.bitnami.com/bitnami | redis | 15.6.4 |
...
| virtualService.yopass.destination.host | string | `"yopass"` |  |
| virtualService.yopass.destination.portNumber | int | `1337` |  |
| virtualService.yopass.gateways[0] | string | `"default/default-gateway"` |  |
| virtualService.yopass.hosts[0] | string | `"yopass.dev.unevenlabs.tools"` |  |
| virtualService.yopass.name | string | `"yopass"` |  |
| virtualService.yopass.type[0] | string | `"VirtualService"` |  |
| virtualService.yopass.whiteListed.ips | list | `[]` |  |
| virtualService.yopass.whiteListed.matchLabels."app.kubernetes.io/instance" | string | `"yopass"` |  |
| virtualService.yopass.whiteListed.matchLabels."app.kubernetes.io/name" | string | `"yopass"` |  |
